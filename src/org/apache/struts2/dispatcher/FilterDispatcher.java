/*
 * $Id: FilterDispatcher.java 708334 2008-10-27 21:46:04Z rgielen $
 *
 ...
 *
 * @version $Date: 2008-10-27 22:46:04 +0100 (Mo, 27. Okt 2008) $ $Id: FilterDispatcher.java 708334 2008-10-27 21:46:04Z rgielen $
 */
public class FilterDispatcher implements StrutsStatics, Filter {
    ...
    protected HttpServletRequest prepareDispatcherAndWrapRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try {
        	if(request.getRequestURI().contains("alice-upload")){
        		System.out.println("앨리스때문에 일반 request를 리턴.");
        		return request;
        	}
        	if(request.getRequestURI().contains("comctrl")){
        		return request;
        	}
        	if(request.getRequestURI().contains("fileup")){
        		return request;
        	}
        	if(request.getRequestURI().contains("carup")){
        		return request;
        	}
